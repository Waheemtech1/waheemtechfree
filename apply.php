...
<body class="bg-slate-50 text-slate-900 min-h-screen">
    ...
    <section class="py-12 px-4 md:py-20 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center mb-10">
                <a href="index.php"
                    class="inline-flex items-center gap-2 text-blue-600 font-bold mb-6 hover:gap-3 transition-all">
                ...
                <p class="text-slate-500 font-medium">Fill the form below to verify your participation and secure your
                    seat.</p>
            </div>

            <div
                class="bg-white rounded-[2.5rem] shadow-2xl shadow-blue-100/50 border border-slate-100 overflow-hidden">
                <form action="" method="POST" enctype="multipart/form-data" class="p-8 md:p-12 space-y-10">

                    <div>
                        <h3 class="text-lg font-bold text-slate-800 mb-6 flex items-center gap-2">
                            <span
                                class="w-8 h-8 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center text-sm">1</span>
                            Personal Information
                        </h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                <label class="text-xs font-black uppercase tracking-widest text-slate-400 ml-1">Full
                                    Name</label>
                            ...
                            <div class="space-y-2">
                                <label class="text-xs font-black uppercase tracking-widest text-slate-400 ml-1">Email
                                    Address</label>
                                <input type="email" name="email" required placeholder="name@example.com"
                                    class="w-full px-5 py-4 rounded-2xl border border-slate-200 bg-slate-50/50 outline-none focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/5 transition-all">
                            </div>
                            <div class="space-y-2">
                                <label class="text-xs font-black uppercase tracking-widest text-slate-400 ml-1">Phone
                                    Number</label>
                                <input type="tel" name="phone" required placeholder="0901 234 5678"
                                    class="w-full px-5 py-4 rounded-2xl border border-slate-200 bg-slate-50/50 outline-none focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/5 transition-all">
                            </div>
                            <div class="space-y-2">
                                <label class="text-xs font-black uppercase tracking-widest text-slate-400 ml-1">Date of
                                    Birth</label>
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-slate-800 mb-6 flex items-center gap-2">
                            <span
                                class="w-8 h-8 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center text-sm">2</span>
                            Program & Location
                        </h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                <label class="text-xs font-black uppercase tracking-widest text-slate-400 ml-1">Select
                                    Your Course</label>
                                <select name="course" required
                                    class="w-full px-5 py-4 rounded-2xl border border-slate-200 bg-slate-50/50 outline-none focus:border-blue-500 focus:bg-white transition-all appearance-none">
                            ...
                            <div class="space-y-2">
                                <label class="text-xs font-black uppercase tracking-widest text-slate-400 ml-1">Current
                                    Location</label>
    ...
    <div class="text-center mb-8">
        <h3 class="text-lg font-bold text-blue-900">Step 3: Social Media Verification</h3>
        <p class="text-sm text-blue-600 font-medium">
            Follow and subscribe to our social media accounts, then upload a screenshot as proof.
        </p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        $platforms = [
            [
                ...
                'color' => 'bg-red-600',
                'field' => 'youtubeProof',
                'url' => 'https://youtube.com/@waheemtech?si=WOyxM3UXfYjM_d0-'
            ],
            [
                'name' => 'TikTok',
                'icon' => 'fa-tiktok',
                'color' => 'bg-black',
                'field' => 'tiktokProof',
                'url' => ' https://www.tiktok.com/@waheem_tech?_r=1&_t=ZS-959hv0xJLJx'
            ],
            [
                'name' => 'Instagram',
                'icon' => 'fa-instagram',
                ...
                'url' => 'https://www.instagram.com/waheemtech001?igsh=MTg1YnR1aThmNjN4eg%3D%3D&utm_source=qr'
            ],
            [
                'name' => 'Twitter/X',
                'icon' => 'fa-x-twitter',
                'color' => 'bg-slate-900',
                'field' => 'twitterProof',
                'url' => ' https://x.com/waheemtech?s=21'
            ],
            [
                'name' => 'Telegram',
                'icon' => 'fa-telegram',
                'color' => 'bg-blue-500',
                'field' => 'telegramProof',
                'url' => 'https://t.me/waheemtech01'
            ]
        ];

        foreach($platforms as $p): ?>
        
        <div class="p-4 bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition">
            
            <!-- CLICKABLE BUTTON -->
            <a href="<?= $p['url'] ?>" target="_blank"
                class="flex items-center justify-between gap-3 mb-3 p-2 rounded-xl hover:bg-slate-50 transition cursor-pointer">

                <div class="flex items-center gap-3">
                    <div class="<?= $p['color'] ?> w-9 h-9 rounded-lg flex items-center justify-center text-white">
                    ...
                    <div class="space-y-6 pt-4">
                        <div class="flex items-center gap-4 bg-slate-50 p-5 rounded-2xl border border-slate-100">
                            ...
                            <label for="agree" class="text-sm text-slate-500 leading-tight">
                                I confirm that the information provided is accurate and I agree to the <span
                                    class="text-blue-600 font-bold underline">WaheemTech</span> terms of service.
                            </label>
                        </div>

                        <button type="submit"
                            class="w-full bg-blue-600 hover:bg-blue-700 text-white py-5 rounded-2xl font-black text-xl shadow-xl shadow-blue-200 transition-all active:scale-[0.98] flex items-center justify-center gap-4">
